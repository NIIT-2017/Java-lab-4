...
public class HRTest
{
    ...
    public void newEmployee2() {
        HR.Test.init();
        assertEquals(false, HR.Test.newEmployee(147, "Ivanov Ivan Ivanovich", "Tester".toUpperCase(), 120, "NULL"));
    }
    @org.junit.Test
    public void newEmployee3() {
        HR.Test.init();
        assertEquals(false, HR.Test.newEmployee(0, "Ivanov Ivan Ivanovich", "Tester".toUpperCase(), 120, "NULL"));
    }
