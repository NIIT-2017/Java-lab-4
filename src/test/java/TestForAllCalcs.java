...
public class TestForAllCalcs {
    ...
    public void CleanerCalc(){
        Cleaner cleaner = new Cleaner(1, "Name", "Cleaner", 150);
    ...
    public void DriverCalc(){
        Driver driver = new Driver(1, "Name", "Driver", 200);
    ...
    public void ProgrammerCalc() {
        Programmer programmer = new Programmer(1, "Name", "Programmer",
                500, 9000000, 0.005);
    ...
    public void TesterCalc() {
        Tester tester = new Tester(1, "Name", "Tester",
                400, 9000000, 0.003);
    ...
    public void TeamLeaderCalc() {
        TeamLeader tl = new TeamLeader(1, "Name", "Team Leader",
    ...
    public void ProjectManagerCalc() {
        ProjectManager pm = new ProjectManager(1, "Name", "Project Manager",
    ...
    public void SeniorManager(){
        SeniorManager sm = new SeniorManager(1, "Name", "Senior Manager",
